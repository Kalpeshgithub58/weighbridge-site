...
export default function MobileStickyCTA() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-navy/95 backdrop-blur-md border-t border-white/10 safe-area-bottom">
      <div className="grid grid-cols-3 divide-x divide-white/10">
        ...
        >
          <MapPin className="w-5 h-5 text-blue-400" strokeWidth={2} />
