      ...
      <main className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                  ...
                  <SpecificationForm
                  productName="Modular Weigh Bridge"
                  description="Connect with our structural engineers for international freight packing metrics, container layouts, and quotations."
                  dropdownLabel="Application Environment"
                  dropdownOptions={["Export Markets & Cross-Border Projects", "Leased Commercial Yards & Infrastructure Contracts", "Remote/Hill Terrain Mining Deployments", "Standard Industrial Yards"]}
                  textareaPlaceholder="Specify destination port details or required modular segment limits..."
                />
