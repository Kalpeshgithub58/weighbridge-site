  ...
  return (
    <div className="pt-[72px] bg-slate-50 text-slate-800 antialiased min-h-screen">
      ...
      <div className="bg-white border-b border-gray-100 py-4">
        <div className="max-w-7xl mx-auto px-4 flex items-center gap-2 text-sm text-slate-500 font-medium">
          ...
          <ChevronRight className="w-4 h-4" />
          <span className="text-slate-900">Crane Scales</span>
        </div>
      </div>
    ...
    <header className="bg-slate-950 text-white py-16 px-4 border-b border-slate-800 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
            <span className="text-amber-500 font-bold tracking-widest text-xs uppercase bg-amber-500/10 px-3 py-1 rounded-full border border-amber-500/20">Heavy-Duty Industrial Lifting</span>
            <h1 className="text-3xl md:text-5xl font-extrabold mt-4 tracking-tight leading-tight">
                Crane Scale <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-600">Weighing Scales</span>
            </h1>
            <p className="text-slate-400 mt-4 text-base md:text-lg max-w-3xl leading-relaxed">
                Empower your industrial lifting with our heavy-duty Crane Scales. Engineered to weigh loads directly from your crane or hoist safely and accurately in factories and warehouses.
            </p>
        </div>
    </header>

    {/*  Main Dynamic Layout  */}
    <main className="max-w-7xl mx-auto px-4 py-1500 g / 1 kgrid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-12">
            ...
            <section className="space-y-6">
                <div className="border-l-4 border-amber-500 pl-4">
                    <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Heavy-Duty Hook & Casing</h2>
                    <p className="text-slate-500 text-sm mt-1">Strong metal casing and industrial hooks designed for safe overhead lifting.</p>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-500 g / 1 kgap-6">
                    {/*  Feature 1  */}
                    <div className="bg-white p-6 rounded-xl border border-slate-200/60 shadow-xs hover:shadow-md transition-all">
                        ...
                        <h3 className="font-bold text-lg text-slate-900 mb-2">Safety Overload Protection</h3>
                        <p className="text-slate-600 text-sm leading-relaxed">
                            Lifting heavy loads requires absolute safety. Our crane scales come with heavy-duty hooks and shackles rated for up to 300% safe overload, protecting the load cell from sudden shock loads.
                        </p>
                    </div>
            ...
            <section className="space-y-6">
                <div className="border-l-4 border-amber-500 pl-4">
                    <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Long Range Remote & Clear Display</h2>
                    <p className="text-slate-500 text-sm mt-1">Designed for easy reading from a distance in dusty environments.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white p-5 rounded-xl border border-slate-200/60 shadow-xs">
                        ...
                        <h4 className="font-bold text-slate-900 mb-2 text-base">Wireless Remote Control</h4>
                        <p className="text-slate-600 text-xs leading-relaxed">Comes with a wireless remote control so operators can zero, tare, and hold weights from a safe distance without needing to touch the scale.</p>
                    </div>

                    {/*  Feature 4  */}
                    <div className="bg-white p-5 rounded-xl border border-slate-200/60 shadow-xs">
                        <div className="text-amber-500 text-xl font-bold mb-3"><i className="fa-solid fa-eye text-xl"></i></div>
                        <h4 className="font-bold text-slate-900 mb-2 text-base">Ultra-Bright LED Display</h4>
                        <p className="text-slate-600 text-xs leading-relaxed">Features a massive, high-intensity red LED display that can be read clearly from up to 30 meters away, even in dark or dusty factories.</p>
                    </div>
            ...
            <section className="bg-gradient-to-br from-slate-900 to-slate-800 text-white p-8 rounded-2xl shadow-sm border border-slate-800">
                <h2 className="text-xl md:text-2xl font-bold mb-6 tracking-tight"><i className="fa-solid fa-store text-amber-500 mr-2"></i>Built to Secure Industrial Lifting</h2>
                
                <div className="grid grid-cols-1 md:grid-cols-500 g / 1 kgap-8">
                    <div>
            ...
            <section className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
                <div className="border-l-4 border-amber-500 pl-4 mb-6">
                    <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Standard Crane Scale Variants</h2>
                    <p className="text-slate-500 text-sm mt-1">Select the optimal capacity and graduation for your lifting needs.</p>
                </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-slate-100 text-sm font-medium text-slate-700 bg-white">
                            <tr className="hover:bg-slate-50/80 transition-colors">
                                <td className="p-4 font-bold text-slate-900">CS-1T</td>
                                <td className="p-4 text-center text-amber-600 font-semibold">1 Ton</td>
                                <td className="p-4 text-center text-slate-500">200 g / 500 g</td>
                                <td className="p-4 text-center text-slate-600">Standard Hook</td>
                            ...
                            <tr className="hover:bg-slate-50/80 transition-colors">
                                <td className="p-4 font-bold text-slate-900">CS-3T</td>
                                <td className="p-4 text-center text-amber-600 font-semibold">3 Ton</td>
                                <td className="p-4 text-center text-slate-500">500 g / 1 kg</td>
                                <td className="p-4 text-center text-slate-600">Standard Hook</td>
                                <td className="p-4 text-center text-emerald-600 font-bold bg-slate-50/50"><i className="fa-solid fa-circle-check"></i> Built-in 6V/4.5Ah</td>
                            </tr>
                            <tr className="hover:bg-slate-50/80 transition-colors">
                                <td className="p-4 font-bold text-slate-900">CS-5T</td>
                                <td className="p-4 text-center text-amber-600 font-semibold">5 Ton</td>
                                <td className="p-4 text-center text-slate-500">500 g / 1 kg / 2 kg / 5 kg</td>
                                <td className="p-4 text-center text-slate-600">Standard Hook</td>
                                <td className="p-4 text-center text-emerald-600 font-bold bg-slate-50/50"><i className="fa-solid fa-circle-check"></i> Built-in 6V/4.5Ah</td>
                            </tr>
                            <tr className="hover:bg-slate-50/80 transition-colors">
                                <td className="p-4 font-bold text-slate-900">CS-10T</td>
                                <td className="p-4 text-center text-amber-600 font-semibold">10 Ton</td>
                                <td className="p-4 text-center text-slate-500">2 kg / 5 kg</td>
                                <td className="p-4 text-center text-slate-600">Standard Hook</td>
                                <td className="p-4 text-center text-emerald-600 font-bold bg-slate-50/50"><i className="fa-solid fa-circle-check"></i> Built-in 6V/4.5Ah</td>
                            </tr>
                        </tbody>
